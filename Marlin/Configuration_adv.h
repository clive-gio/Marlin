 ...
 */
#define E0_AUTO_FAN_PIN FAN1_PIN  //cgi
#define E1_AUTO_FAN_PIN FAN1_PIN  //cgi
...
//#define E_DUAL_STEPPER_DRIVERS  //cgi E1
#if ENABLED(E_DUAL_STEPPER_DRIVERS)
  //#define INVERT_E1_VS_E0_DIR       // E direction signals are opposites  //cgi E1
#endif
...
#define BABYSTEPPING  //cgi Level
  ...
  #define BABYSTEP_ZPROBE_OFFSET          // Combine M851 Z and Babystepping  //cgi Level
...
#define LIN_ADVANCE  //cgi LIN
  ...
  #endif
  //#define ADVANCE_K_EXTRA       // Add a second linear advance constant, configurable with M900 L.  //cgi LIN
...
#define PTC_BED      // Compensate based on bed temperature //cgi Level1
//#define PTC_HOTEND   // Compensate based on hotend temperature
   ...
   */
  #define PTC_LINEAR_EXTRAPOLATION 4  //cgi Level1
...
#define MIN_STEPS_PER_SEGMENT 1  //cgi Volumetric (6)
 ...
 */
#define MINIMUM_STEPPER_POST_DIR_DELAY 20  //cgi Stepper
#define MINIMUM_STEPPER_PRE_DIR_DELAY 20  //cgi Stepper
 ...
 */
  ...
  #define INTERPOLATE      true
    ...
    #define X_CURRENT       1200        // (mA) RMS current. Multiply by 1.414 for peak current. //cgi 
...
//#define NO_VOLUMETRICS
   ...
   */
  #define VOLUMETRIC_DEFAULT_ON  //cgi Volumetric

  #define VOLUMETRIC_EXTRUDER_LIMIT  //cgi Volumetric
 ...
 * @section calibrate
 */
//#define MECHANICAL_GANTRY_CALIBRATION  //cgi Level1
